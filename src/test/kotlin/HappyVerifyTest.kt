...
class HappyVerifyTest {
    ...
    inner class TestSumOfDigitsSquared {
        ...
        @TestFactory
        @DisplayName("Test SumOfDigitsSquared Sample")
        fun sumOfDigitsSquaredSample() = listOf(
            7L to 7L,
            145L to 145L,
            199L to 199L,
        ).map { (input, input2) ->
        ...
        @TestFactory
        @DisplayName("Test isHappy Sample")
        fun isHappySample() = listOf(
            100L to 100L,
            111L to 111L,
            1234L to 1234L,
            989L to 989L,
        ...
        @TestFactory
        @DisplayName("Test firstK Sample")
        fun firstKSample() = listOf(
            11 to 11,
        ).map { (input, input2) ->
            DynamicTest.dynamicTest("$input") {
